		...
		describe(`Given a valid user`, () => {
			...
			it(`inserts 1 language with words for the new user`, () => {
				...
				const expectedList = {
					...
					total_score: 0,
					words: [
						{ original: "ad infinitum", translation: "to infinity" },
						{ original: "antebellum", translation: "before the war" },
						{ original: "aurora borealis", translation: "northern lights" },
						{ original: "cum laude", translation: "with honor" },
						{ original: "curriculum vitae", translation: "course of life" },
						{
